...
//	public static double INCREASE_CHANCE_TO_TEST_POSITIVE = 25; //good case
	public static double INCREASE_CHANCE_TO_TEST_POSITIVE = 16; //bad case
...
//	public static double DAILY_RATE_OF_SPREAD_UNIMPEDED = 1.4; //with reduced infectiousness
	...
	public static double DAILY_RATE_OF_SPREAD_NO_CLUE = 1.3;
//	public static double DAILY_RATE_OF_SPREAD_NO_CLUE = 1.7;
	 ...
	 * 26k daily tests
	 * 28.3. 57,7k positive
	 * tests = 300-410k+26000*days
	 *  
	 * 5sqrt(57,7k/(430k+540k)/2/3,5/0,0238) = 1,0739
	 * 
	 * 
	 * 
	 */
	
	public static double DAILY_RATE_OF_SPREAD_NO_CONTACT = 1.0739; //good case
...
//	public static double FATALITY_OVERESTIMATION =
	 ...
	 * 
	 */
	public static final double HOSPITAL_WHEN_SICK = 0.02;
