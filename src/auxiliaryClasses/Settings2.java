...
public class Settings2 {
	...
	public static double INCREASE_CHANCE_TO_TEST_POSITIVE = 15;
	...
	public static double DAILY_RATE_OF_SPREAD_NO_CLUE = 1.25;
	...
	public static double DAILY_RATE_OF_SPREAD_NO_CONTACT = 1.09;
...
//	public static double FATALITY_OVERESTIMATION =
	 ...
	 * 
	 */
	public static final double HOSPITAL_WHEN_SICK = 0.045;
	...
	public static final double DIE_FUNCTIONING = 0.25;
	public static final double DIE_OVERWHELMED = 0.75;
	
	/*
	 * care unit date from https://www.divi.de/aktuelle-meldungen-intensivmedizin/covid-19-erste-daten-fuer-die-anzahl-von-patienten-sowie-verfuegbaren-intensivbetten
	 * 
	...
	public static int INTENSIVE_CAPACITY = 15000;
